...
from monolithcaching.root_directory import RootDirectory


class TestRootDirectory(TestCase):

    @patch("monolithcaching.root_directory.RootDirectory._extract_path")
    ...
    @patch("monolithcaching.root_directory.tempfile")
    @patch("monolithcaching.root_directory.RootDirectory.__init__")
